...
public class ServicesService {
    ...
    public PageImpl<ServicesResponse> getAllServices(int page, int size) {
        ...
        Page<Services> servicePage = servicesRespository.findAllByDeletedAtIsNull(pageable);
    ...
    public ServicesResponse getServiceById(int id) {
        return servicesMapper.toServiceResponse(servicesRespository.findByServiceIdAndDeletedAtIsNull(id)
    ...
    public ServicesResponse createService(ServicesRequest request){
        ...
        return servicesMapper.toServiceResponse(servicesRespository.save(services));
    }

    public ServicesResponse updateService(int id, ServicesRequest request){
        Services services = servicesRespository.findByServiceIdAndDeletedAtIsNull(id).orElseThrow(
    ...
    public void deleteService(int id) {
        ...
        servicesRespository.save(services);
    }
}
